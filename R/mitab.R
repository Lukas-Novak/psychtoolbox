...
#' @param yes_no_results logical, if TRUE than lasy output indicating difference between models is added, currently working only based on CFI
...
#' @export
#......................................................
mitab = function(group1_nam, group2_nam, ordered, model, data, std.lv, meanstructure, group, yes_no_results, estimator, robust = FALSE, cfi.difference = FALSE) {
